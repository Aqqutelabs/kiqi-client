      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <Card>
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            ...
            odio qui animi! Ipsam, vel beatae, accusamus velit soluta. Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi, itaque esse maiores, reprehenderit corrupti ab temporibus expedita debitis possimus magnam quis dolores! Exercitationem, accusantium repellendus eius quae libero distinctio quo possimus error ab delectus eos voluptatem architecto nostrum! Voluptatum ipsa ipsum natus non.
            <span className="text-sm text-[#233E97] cursor-pointer ml-4">View less</span>
          </p>
        </Card>
      </div>
