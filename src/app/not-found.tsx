  ...
  return (
    <div
      ...
      <div className="flex flex-col items-center text-center px-4">
        <h1 className="text-[#F95417] text-[50px] font-bold mb-2">404</h1>
        <p className="text-[#1c0d0e] text-lg mb-6 font-semibold">
          Oops! The page you&apos;re looking for does not exist.
        </p>
        <Link
          href={"/dashboard"}
          className="h-12 bg-[#F95417] w-fit px-5 flex justify-center items-center text-white text-sm rounded-lg cursor-pointer">
          Back to Home
        </Link>
        <span className="my-10 text-sm">
          Having trouble? Contact our <br />{" "}
          <Link href={"#"} className="text-[#F95417] underline">
            help center
          </Link>
        </span>
      </div>
