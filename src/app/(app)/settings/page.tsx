...
const SettingsPage: React.FC = () => {
  ...
  const [settingsData, setSettingsData] = useState<Record<string, boolean>>(initialSettings);
  ...
  return (
    <main className="space-y-6">
      ...
      <div className="flex gap-3 mb-4">
       ...
       <Button onClick={resetToDefaults} variant={"tertiary"}>Reset to Defaults</Button>
      </div>

      <div className="space-y-5">
        {settings.map((section, index) => (
          <div key={index} className="space-y-3 p-4 bg-white rounded-lg border border-gray-200">
      ...
      <div className="space-y-3 p-4 bg-white rounded-lg border border-gray-200">
        ...
        <ul className="space-y-2">
          ...
          <li className="text-[#233E97] text-sm cursor-pointer py-2 hover:text-[#1a2c73] transition-colors">
            Change Password
          </li>
          <li 
