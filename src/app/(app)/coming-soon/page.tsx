...
const ComingSoonPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-linear-to-br from-cyan-50 to-cyan-100 px-4">
      <motion.div
        ...
        <p className="text-gray-600 text-center mb-6">
          ...
          and new tools to help you manage your business even better!
        </p>
