...
export default function FeatureTwoPage() {
  ...
  const moreBenefits = [
    { icon: Rocket, title: "Launch in 48 Hours", description: "Campaigns live almost instantly." },
    { icon: MessageCircle, title: "Hands-Off Execution", description: "Strategy + copy + scheduling done for you." },
    { icon: TrendingUp, title: "Scale Without Hiring", description: "No need for a marketer, designer, or copywriter." },
    { icon: Layout, title: "Optional Add-Ons", description: "Landing pages, funnels, and automations when you're ready." },
    { icon: CheckCircle, title: "One-Click Approvals", description: "Review campaigns in minutes, not hours." },
  ]
  ...
  return (
    <section>
      <LandingNav />
      {/* hero section */}
      <div className="min-h-screen w-full bg-gradient-to-b from-[#2BAAE2] to-[#020D1D] flex flex-col items-center justify-center pt-16 md:pt-20 relative overflow-hidden px-4 sm:px-6">
        {/* floating elements */}
        <Image
        ...
        <div className="flex flex-col justify-center items-center space-y-4 md:space-y-5 px-4 mb-6 md:mb-8 w-full max-w-6xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-b from-[#FFF] via-[#f8e58f] to-[#FED93B] text-transparent bg-clip-text leading-tight text-center">
            Email Marketing That Runs Itself
          </h1>

          <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl text-center max-w-3xl">
            We do the strategy, write the copy, set the schedule, and hit send. You just approve and watch
            results roll in.
          </p>

          <div className="flex flex-col sm:flex-row items-center gap-4 text-sm font-medium mt-2">
            <button className="h-12 sm:h-14 px-4 sm:px-6 w-full sm:w-[200px] rounded-lg flex justify-center items-center bg-white text-[#111111] hover:cursor-pointer relative">
              Get Started Today
              <div className="size-[24px] sm:size-[30px] rounded-full flex justify-center items-center bg-[#020617] border border-white rotate-45 absolute -right-2 sm:-right-3 z-10">
                <ArrowUp color="white" size={12} className="sm:w-4 sm:h-4" />
              </div>
            </button>
            <button className="h-12 sm:h-14 px-4 sm:px-6 w-full sm:w-[200px] rounded-lg flex justify-center items-center border-white border text-white hover:cursor-pointer">
              See Concierge Plans
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 relative w-full max-w-[500px] sm:max-w-[600px] h-[300px] sm:h-[400px] md:h-[500px] mt-6 md:mt-8">
          <Image
      ...
      <div className="space-y-6 my-10 sm:my-16 md:my-20 px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6 sm:gap-10 md:gap-16 opacity-50 px-4">
          {trustedCompaniyImages.map((src, index) => (
            <div key={index} className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14">
              <Image
                src={src}
                alt={`Company ${index + 1}`}
                width={56}
      ...
      <div className="space-y-4 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-7xl mx-auto my-6 sm:my-8 md:my-10">
          {whyEmailMarketingMatters.map((item, index) => (
            <div
              key={index}
              className="h-[200px] sm:h-[220px] md:h-[250px] w-full rounded-xl sm:rounded-2xl bg-[#E5F6FD] p-4 sm:p-6 flex flex-col justify-between">
              <Image
                src={item.icon}
                alt={item.title}
                height={50}
          ...
          <div className="h-[200px] sm:h-[220px] md:h-[250px] w-full rounded-xl sm:rounded-2xl relative col-span-1 sm:col-span-2 lg:col-span-1">
            <Image
      ...
      {/* how concierge works */}
      <div className="space-y-5 bg-[#F3F6FF] py-8 sm:py-10 md:py-16 px-4 sm:px-6 md:px-8 lg:px-0 mx-2 sm:mx-4 md:mx-6 lg:mx-10 my-10 sm:my-12 md:my-16 rounded-xl sm:rounded-2xl md:rounded-[30px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-rows-auto md:grid-rows-2 gap-3 sm:gap-4 mx-2 sm:mx-4 md:mx-6 lg:mx-10">
          ...
          <div className="border border-gray-100 bg-[#2BAAE2] relative rounded-lg sm:rounded-xl md:rounded-[20px] w-full md:row-span-2 flex flex-col justify-between p-4 sm:p-6">
            ...
            <div className="relative w-full h-[180px] sm:h-[220px] md:h-[340px] mt-4">
              <Image
          ...
          <div className="border border-gray-100 bg-[#E9F5D7] rounded-lg sm:rounded-xl md:rounded-[20px] w-full p-4 sm:p-6 flex flex-col justify-between">
            <div className="relative w-full h-[120px] sm:h-[140px] mb-4">
              <Image
            ...
            <div className="text-black">
              <h4 className="font-extrabold text-lg sm:text-xl md:text-2xl">Tell us your goal.</h4>
              <p className="text-sm sm:text-base md:text-lg mt-2">
          ...
          <div className="border border-gray-100 bg-[#F9D5FF] rounded-lg sm:rounded-xl md:rounded-[20px] w-full p-4 sm:p-6 flex flex-col justify-between">
            ...
            <div className="text-black">
              <h4 className="font-extrabold text-lg sm:text-xl md:text-2xl">Approve and relax.</h4>
              <p className="text-sm sm:text-base md:text-lg mt-2">
          ...
          <div className="border border-gray-100 bg-[#FFF] rounded-lg sm:rounded-xl md:rounded-[20px] w-full p-4 sm:p-6 flex flex-col md:flex-row items-center justify-between md:col-span-2 lg:col-span-2 gap-4">
            <div className="relative w-full md:w-1/2 h-[150px] sm:h-[170px] md:h-[190px]">
              <Image
            ...
            <div className="text-black md:w-1/2">
              ...
              <p className="text-sm sm:text-base md:text-lg mt-2">
                No confusing dashboards. Just see how many emails were sent,
                who engaged, and what sales came in.
              </p>
            </div>
          </div>
        </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mx-auto max-w-7xl">
    {conciergeFeatures.map((item, idx) => {
      ...
      return (
        <div
          ...
          className={`
            ...
            ${isBlue ? "bg-gradient-to-b from-[#233E97] to-[#2BAAE2] text-white" : "bg-white text-black"} 
            flex ${isBlue ? "flex-col justify-between gap-4" : "flex-col md:flex-row items-center gap-4 sm:gap-6 justify-center"}
          `}>
          <div className={`relative ${isBlue ? "w-full" : "md:w-1/3 lg:w-2/5"} h-[120px] sm:h-[145px]`}>
            <Image
              src={item.icon}
              alt={item.title}
              fill
          ...
          <div className={`space-1 ${isBlue ? "w-full" : "md:w-2/3 lg:w-3/5"}`}>
            <h4 className="font-extrabold text-lg sm:text-xl md:text-[22px]">{item.title}</h4>
            <p className="text-sm sm:text-base md:text-lg mt-1">{item.description}</p>
          </div>
        </div>
      );
    })}
      ...
      <div className="relative m-4 sm:m-6 md:m-8 lg:m-12 p-4 sm:p-6 md:p-8 lg:p-12 h-[250px] sm:h-[280px] md:h-[320px] lg:h-[355px] rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden text-[#000015]">
        {/* Background image */}
        <Image
      ...
      <div className="min-h-screen bg-linear-to-b to-[#2BAAE2] from-[#020D1D] p-4 sm:p-6 md:p-8 lg:p-10">
        ...
        <div className="max-w-6xl mx-auto my-6 sm:my-8 md:my-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
            {realBenefits.slice(0, 3).map((benefit, idx) => (
              <div
                key={idx + 3}
                className="bg-white/10 backdrop-blur-2xl rounded-xl p-4 sm:p-6 border border-white/20 flex justify-center items-center flex-col gap-3 sm:gap-4 h-[200px] sm:h-[230px]">
                {/* Icon */}
                <div className="size-[80px] sm:size-[100px] bg-linear-to-b from-[#D8E6EA] to-[#FED93B] rounded-full flex justify-center items-center">
                  <img src={benefit.icon} alt="Icon" className="w-10 h-10 sm:w-12 sm:h-12" />
                </div>
        ...
        <div className="w-full max-w-7xl mx-auto my-6 sm:my-8 md:my-10 lg:my-16 xl:my-20 px-2 sm:px-4">
          <div className="flex justify-start sm:justify-center overflow-x-auto scrollbar-hide gap-3 sm:gap-4 md:gap-6 pb-4 sm:pb-6 -mx-2 sm:mx-0 px-2 sm:px-0">
            {/* Card 1 */}
            <div className="flex-shrink-0 w-[280px] sm:w-[320px] md:w-[350px] lg:w-[400px] h-[250px] sm:h-[280px] md:h-[300px] lg:h-[330px] rounded-xl sm:rounded-2xl md:rounded-[30px] bg-white flex flex-col items-start justify-between p-4 sm:p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="space-y-5 my-12 sm:my-16 md:my-20 px-4 sm:px-6">
        ...
        <div className="pt-6 sm:pt-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 bg-gradient-to-br from-yellow-50 via-orange-50 to-yellow-100 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
             ...
             <div className="space-y-4 sm:space-y-6">
              ...
              <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[430px] mt-8 lg:mt-0">
                  <Image 
      ...
      {/* last cta section */}
      <div className="bg-gradient-to-b from-blue-900 via-blue-800 to-cyan-400 flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 lg:gap-12 xl:gap-20 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-16 py-6 sm:py-8 md:py-10 lg:py-16 w-[95%] rounded-xl sm:rounded-2xl mx-auto my-8 sm:my-10 md:my-14 lg:my-20">
        {/* left corner */}
        <div className="max-w-2xl space-y-3 sm:space-y-4 md:space-y-6 lg:space-y-8 w-full lg:w-1/2">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 text-sm font-medium">
            <button className="h-10 sm:h-12 md:h-14 px-4 sm:px-6 w-full sm:w-auto rounded-lg flex justify-center items-center bg-white text-[#111111] hover:cursor-pointer relative group">
              ...
              <div className="w-5 h-5 sm:w-6 sm:h-6 md:w-[30px] md:h-[30px] rounded-full flex justify-center items-center bg-[#020617] border border-white rotate-45 absolute -right-2 sm:-right-3 z-10">
                <ArrowUp color="#FFF" size={10} className="sm:w-3 sm:h-3 md:w-4 md:h-4" />
              </div>
            </button>
          </div>
        </div>
        ...
        <img
          ...
          alt="Image"
          className="w-full lg:w-1/2 h-auto max-h-[200px] sm:max-h-[250px] md:max-h-[300px] lg:max-h-full object-contain mt-6 lg:mt-0"
        />
      </div>
      <FAQFooter />
    </section>
