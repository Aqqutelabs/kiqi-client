...
import { Plus, Minus, Facebook, Instagram, Linkedin, Youtube, MessageCircle, AtSign } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 px-4 sm:px-6 md:px-8 lg:px-6 py-8 sm:py-12 md:py-16 max-w-4xl mx-auto w-full">
        <h2 className="bg-gradient-to-b from-[#2BAAE2] to-[#233E97] text-transparent bg-clip-text font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[47px]">FAQ</h2>
        ...
        <div className="space-y-0 mt-6 sm:mt-8">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-300">
              ...
              >
                <span className={`text-xs sm:text-sm font-medium pr-4 sm:pr-6 md:pr-8 ${
                ...
                <span className="flex-shrink-0">
                  {openIndex === index ? (
                    <Minus className="w-4 h-4 sm:w-5 sm:h-5 text-gray-900" strokeWidth={2} />
                  ) : (
                    <Plus className="w-4 h-4 sm:w-5 sm:h-5 text-gray-900" strokeWidth={2} />
                  )}
                </span>
              </button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-8 sm:gap-10 md:gap-12">
            ...
            <div className="max-w-lg">
              ...
              <p className="text-xs sm:text-sm text-white leading-relaxed">
                Kiki is the email marketing platform built for founders, beginners, and busy owners. Launch campaigns in minutes, track only what matters, and grow without the overwhelm. Simple, smart, and secure — the way email should be.
              </p>
            </div>
            ...
            <div className="flex gap-8 sm:gap-12 md:gap-16">
              <div>
                <ul className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 md:gap-5 lg:gap-14 flex-wrap">
                  <li><a href="#" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors whitespace-nowrap">Home</a></li>
                  <li><a href="#" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors whitespace-nowrap">Feature</a></li>
                  <li><a href="#" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors whitespace-nowrap">Services</a></li>
                  <li><a href="#" className="text-xs sm:text-sm text-gray-300 hover:text-white transition-colors whitespace-nowrap">Pricing</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-8 sm:mt-10 md:mt-12 pt-6 sm:pt-8 border-t border-gray-800 gap-4 sm:gap-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
              <span className='text-xs sm:text-sm md:text-base block whitespace-nowrap'>Kiki © 2024 All rights reserved.</span>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                <a href="#" className="hover:text-white transition-colors text-xs text-gray-400">Privacy Policy</a>
                <span className="hidden sm:inline text-gray-400">|</span>
                <a href="#" className="hover:text-white transition-colors text-xs text-gray-400">Terms of Service</a>
              </div>
            </div>
            
            <div className="flex items-center gap-3 sm:gap-4">
              <a href="#" className="text-gray-400 hover:text-white transition-colors" aria-label="Facebook">
                <Facebook className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" />
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
                <Instagram className="w-3 h-3 sm:w-4 sm:h-4" />
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors" aria-label="LinkedIn">
                <Linkedin className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" />
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors" aria-label="YouTube">
                <Youtube className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" />
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors" aria-label="Message">
