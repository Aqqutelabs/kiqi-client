...
const ToolbarButton = ({
  ...
  <button
    ...
    title={title}
    disabled={disabled}
    className={`p-2 rounded transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
      active
  ...
  return (
    <div className={`border border-gray-300 rounded-lg overflow-hidden ${className}`}>
      ...
      <div className="px-4 py-2 bg-gray-50 text-xs text-gray-500 border-t border-gray-300">
        Tip: Paste plain text to avoid formatting issues. Use Shift+Enter for line breaks.
      </div>
    </div>
  );
};
