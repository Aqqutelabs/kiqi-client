...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-[300px] flex-shrink-0 bg-white border-r border-gray-200 hidden md:flex flex-col h-screen">
      {/* Header */}
                  ...
                  return (
                    <li key={itemIndex}>
                      ...
                      <button
                        ...
                        className={clsx(
                          "w-full h-[50px] flex items-center justify-between px-5 py-2 text-sm font-normal transition-colors",
                          {
                            ...
                            return (
                              <li key={subIndex}>
                                <Link
                                  href={subItem.href}
                                  className={clsx(
                                    "flex items-center gap-1.5 pl-8 py-2 text-[13px] font-normal transition-colors relative",
                                    {
                                      "text-[var(--primary)] bg-gradient-to-r from-[#233E9726] via-white to-[##C4C4C400]": isActive,
                                      "text-[#42526D] hover:text-[var(--primary)]":
                                        !isActive,
                                    }
                                  )}>
                ...
                return (
                  <li key={itemIndex}>
                    <Link
                      href={item.href}
                      className={clsx(
                        "flex items-center gap-2.5 px-5 py-2 text-sm font-normal h-[50px] transition-colors relative",
                        {
                          "text-[var(--primary)] bg-gradient-to-r from-[#233E9726] via-white to-[##C4C4C400]": isActive,
                          "text-[#42526D] hover:text-[var(--primary)]": !isActive,
                        }
                      )}>
                      {/* Active indicator - left border */}
                      {isActive && (
