            ...
            >
              ...
              >
                ...
                <div className="flex flex-col justify-between h-full w-2/4">
                  ...
                  {item.subtitle && <p className="text-sm md:text-base text-center md:text-left mt-2">
                    "{item.subtitle}"
                  </p>}
                  </div>
                  <img src={isEven ? "/kiki-logo.svg" : "/kiki-logo-white.svg"} alt="Logo" className="h-10 w-20 object-cover" />
                </div>
                {/* image */}
                <img 
                  src={item.image} 
