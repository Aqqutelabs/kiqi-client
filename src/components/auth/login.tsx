...
//                     <input type="checkbox" className="h-4 w-4 rounded border-gray-300 text-[#FF5314] focus:ring-[#FF5314]" />
//                     <span className="ml-2 text-gray-600">Remember Me</span>
//                 </label>
//                 <Link href="/auth/reset-password" className="font-medium text-[#FF5314] hover:underline">Forgot Password?</Link>
//             </div>
...
//           Do not have an account? <Link href="/auth/signup" className="font-medium text-[#FF5314] hover:underline">Sign Up</Link>
//         </p>
//       </Card>
//     </AuthLayout>
//   );
